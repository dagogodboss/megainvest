...
<html lang="{{ app()->getLocale() }}">
 ...
 @stack('before-style')
	...
	<link class="main-stylesheet" href="{{asset('pages/css/themes/trade.css')}}" rel="stylesheet" type="text/css" />
	 @stack('after-style')
...
<body class="fixed-header dashboard menu-pin">
	<div class="page-container">
		...
		<div class="page-content-wrapper ">
			<div class="content sm-gutter trade-gutter">
				...
				<div class="container-fluid p-l-5 p-r-25 p-t-0 p-b-25 sm-padding-10">
					<div class="row">
						@yield('content')
					</div>
				</div>
 ...
 @stack('before-scripts')
	...
	<script src="{{asset('assets/js/stock.js')}}" type="text/javascript"></script>
